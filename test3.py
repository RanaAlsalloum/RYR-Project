...
model = pickle.load(open("/Users/ranasalloum/PycharmProjects/myProject1/final_model.pickle", 'rb'))
scaler = pickle.load(open("/Users/ranasalloum/PycharmProjects/myProject1/scaler.pickle", 'rb'))
